...
-- Add yourself as an author
 INSERT INTO authors (name , nationality, birth_year) VALUES ('Dalia', 'SA', 1991);
-- Add two books that you'd like to write (you can hard-code your id as the author id)
INSERT INTO books (title, publication_date, author_id) VALUES ('WHAT YOU WANT', 2019, 9);
INSERT INTO books (title, publication_date, author_id) VALUES ('NULL', 2018, 9);
-- Update one of your books to have a new title
UPDATE books SET title='HI ALL' WHERE title='WHAT YOU WANT';
-- Delete your books
