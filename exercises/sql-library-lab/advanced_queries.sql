...
SELECT * FROM books JOIN authors ON authors.nationality=nationality WHERE authors.nationality= 'China' OR authors.nationality='Uited Kingdom';
...
SELECT * FROM authors JOIN books ON authors.name=name WHERE books.title LIKE 'N%';